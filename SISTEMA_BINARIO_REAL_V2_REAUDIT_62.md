...
- DOG | val 25/36 (69.44%) | train 42/66 (63.64%) | lift +19.85 | AH_FAMILY=AH_0_25 + FAV_RECENT_STATS_LEAN_FOR
- DOG | val 15/22 (68.18%) | train 67/105 (63.81%) | lift +18.59 | BASE_STATS=STATS_STRONG_FOR + OU_4_PLUS
- DOG | val 15/22 (68.18%) | train 67/105 (63.81%) | lift +18.59 | BASE_STATS=STATS_STRONG_FOR + OU_4_PLUS + OU_FAMILY=OU_EXTREME
- FAVORITE | val 19/28 (67.86%) | train 46/74 (62.16%) | lift +17.45 | AH_EXACT=0.75 + IND_DOG_MARGIN_M_DRAW
- DOG | val 23/34 (67.65%) | train 58/88 (65.91%) | lift +18.06 | BASE_PRESSURE=PRESSURE_NEW_FAV + IND_FAV_COVER_FAIL + OU_FAMILY=OU_MID
- DOG | val 14/21 (66.67%) | train 42/66 (63.64%) | lift +17.08 | BASE_TOTAL=TOTAL_PUSH_LINE + IND_DOG_FRESH + OU_FAMILY=OU_LOW
- DOG | val 14/21 (66.67%) | train 42/66 (63.64%) | lift +17.08 | BASE_TOTAL=TOTAL_PUSH_LINE + IND_DOG_OU_OWN_UNKNOWN + OU_FAMILY=OU_LOW
- DOG | val 14/21 (66.67%) | train 42/66 (63.64%) | lift +17.08 | BASE_TOTAL=TOTAL_PUSH_LINE + IND_DOG_PREV_OU_UNKNOWN + OU_FAMILY=OU_LOW
- DOG | val 13/20 (65.0%) | train 38/61 (62.3%) | lift +15.41 | BASE_TOTAL=TOTAL_UNDER_LINE + FAV_RECENT_MARGIN_M_GE_POS3 + OU_FAMILY=OU_MID
...
- FAVORITE | val 16/25 (64.0%) | train 41/64 (64.06%) | lift +13.59 | BASE_PRESSURE=PRESSURE_LOWER + IND_FAV_SHORT_CURRENT_AH + OU_FAMILY=OU_LOW
...
- OVER | val 17/26 (65.38%) | train 40/62 (64.52%) | lift +16.19 | BASE_STATS=STATS_NEUTRAL + H2H_GENERAL_COVER_FAIL + OU_FAMILY=OU_MID
- UNDER | val 15/23 (65.22%) | train 43/69 (62.32%) | lift +14.41 | BASE_PRESSURE=PRESSURE_LOWER + BASE_TOTAL=TOTAL_OVER_LINE + OU_FAMILY=OU_HIGH
- UNDER | val 13/20 (65.0%) | train 40/63 (63.49%) | lift +14.19 | BASE_STATS=STATS_STRONG_FOR + IND_DOG_MARGIN_M_POS1 + OU_FAMILY=OU_HIGH
- UNDER | val 21/33 (63.64%) | train 55/81 (67.9%) | lift +12.83 | AH_SUPER=AHS_LOW + BASE_TOTAL=TOTAL_UNDER_LINE + IND_DOG_MARGIN_M_POS1
- UNDER | val 24/38 (63.16%) | train 42/60 (70.0%) | lift +12.35 | AH_FAMILY=AH_0_25 + BASE_PRESSURE=PRESSURE_NEW_FAV + BASE_STATS=STATS_STRONG_FOR
